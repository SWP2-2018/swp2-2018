...
public class User {
    ...
    public User(String email, String password, byte instructor, String last_name, String first_name, String job, int educational_year, int instructor_id, Date start_date) {
        this.email = email;
